...
rows = int(img_shape[0]/8) #高 切割數量
cols = int(img_shape[1]/8) #寬 切割數量
channels_for_gray = 1
img=img.reshape(img_shape[0], img_shape[1], channels_for_gray)
'''

encode_start = time.time()
abc = encode.encode(img, w)
